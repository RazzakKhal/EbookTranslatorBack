...
public class TranslateEbookService implements TranslateEbookUseCase {
    ...
    public TranslateEbookService(EpubFormatValidator epubFormatValidator, ExtractEpubPort extractEpubPort, ContentOpfParser contentOpfParser) {
    ...
    public void translate(TranslateEbookCommand command) {
        ...
        System.out.println(parsedContentOpf);
